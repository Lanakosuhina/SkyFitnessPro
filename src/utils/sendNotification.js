export default function sendNotification(type, text) {
  ...
  component.className = `relative flex items-center bg-blueLight text-white text-2xl font-bold px-4 py-5 rounded-md opacity-0 transform transition-all duration-500`;
  component.innerHTML = `
